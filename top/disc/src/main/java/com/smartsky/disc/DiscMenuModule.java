...
public class DiscMenuModule extends ELBasicExModule{
    private View discMenu;
    ...
    private void initView(){
        discMenu = LayoutInflater.from(context).inflate(R.layout.disc_menu_module,parentTop,true);
    }
}
